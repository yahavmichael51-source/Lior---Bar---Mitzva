// Storage layer. Uses PostgreSQL when DATABASE_URL is set (recommended for hosting),
  ...
  return {
    ...
    async updateResponse(id, { firstName, status, people }) {
      const row = db
        ...
        .get(firstName, status, people, now(), id);
...
module.exports = { openDatabase, DEFAULT_EVENT };
